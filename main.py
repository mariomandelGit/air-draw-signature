...
def openNewWindow(window):
    ...
    tk.Label(newWindow, text="Once you're finished, if you would like to save your signature you may either press "
             ...
             font=InstructionFont, bg='#D9CB8D').pack()
    tk.Button(text="Click here to start process", command=lambda : openSigWindow())
...
class Application():
    ...
    def __init__(self):
        ...
        tk.Button(text='Draw Your Signature', height=4, width=25, bg='grey', font=buttonFont, command=lambda : openNewWindow(window)).place(x=380, y=125)
